...
var (
	...
	Deployments = map[ChainIdHash]ProtocolHistory{
		Mainnet: {
			...
			{PtSeouLo, 0, 10279489, 11640288, 998, 2, 10800, 10800}, // v23
			{ProtoV024, 0, 11640289, -1, 1124, 2, 14400, 14400},     // v24 Tallinn
		},
		Ghostnet: {
			...
			{PtSeouLo, 0, 14898849, 17706848, 1739, 2, 10800, 10800}, // v23
			{ProtoV024, 0, 17706849, -1, 1999, 2, 10800, 10800},      // v24 Tallinn (ghostnet keeps 4s block time)
		},
		Shadownet: {
			{ProtoGenesis, 0, 0, 0, 0, 2, 4096, 256},            // 0
			{ProtoBootstrap, 0, 1, 1, 0, 2, 10800, 10800},       // 0
			{PsRiotum, 0, 2, 453600, 0, 2, 10800, 10800},        // v22
			{PtSeouLo, 0, 453601, 1814400, 42, 2, 10800, 10800}, // v23
			{ProtoV024, 0, 1814401, -1, 168, 2, 10800, 10800},   // v24 Tallinn
		},
	}
)
