...
var (
	...
	Deployments = map[ChainIdHash]ProtocolHistory{
		Mainnet: {
			...
			{PtSeouLo, 0, 10279489, 10290288, 998, 2, 10800, 10800}, // v23
			{PtTALLiN, 0, 10290289, -1, 999, 2, 14400, 14400},       // v24
		},
		Ghostnet: {
			...
			{PtSeouLo, 0, 14898849, 14909648, 1739, 2, 10800, 10800}, // v23
			{PtTALLiN, 0, 14909649, -1, 1740, 2, 14400, 14400},       // v24
		},
		Shadownet: {
			{ProtoGenesis, 0, 0, 0, 0, 2, 4096, 256},           // 0
			{ProtoBootstrap, 0, 1, 1, 0, 2, 10800, 10800},      // 0
			{PsRiotum, 0, 2, 453600, 0, 2, 10800, 10800},       // v22
			{PtSeouLo, 0, 453601, 464400, 42, 2, 10800, 10800}, // v23
			{PtTALLiN, 0, 464401, -1, 43, 2, 14400, 14400},     // v24
		},
	}
)
